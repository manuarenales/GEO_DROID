...
namespace GEO_DROID.Services
{
    class GEOClient : TCPNetClientBase
    {
        ...
        private GeoDroidDatabase _geoDroidDatabase;

        public GEOClient(bool useSSL, bool useClientCertificates, bool useCompression, GeoDroidDatabase geoDroidDatabase) : base(useSSL, useClientCertificates, useCompression)
        {
            _geoDroidDatabase = geoDroidDatabase;
        }
                ...
                if (Client.Client.Connected) //Check if the socket is connected because the timeout was reached and externally it was asked to disconnect
                {
                    ...
                    if (commFinished)
                    {
                        ...
                        else if (_processCommandDelegate != null)
                        {
                            ...
                            List<Configuration> gog = _geoDroidDatabase._database.Table<Configuration>().ToListAsync().Result;
